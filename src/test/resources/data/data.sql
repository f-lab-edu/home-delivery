...
(
    ...
    CONSTRAINT `user_address_ibfk_1` FOREIGN KEY
(
    `user_id`
) REFERENCES `user`
(
    `id`
                                                               ...
                                                               ON DELETE CASCADE
                                                               ON UPDATE CASCADE,
    CONSTRAINT `user_address_ibfk_2` FOREIGN KEY
(
    `address_id`
) REFERENCES `address`
(
...
(
    ...
    KEY `idx_store_address_id_category_id_status`
(
    `address_id`,
    `category_id`,
    `status`
) /*!80000 INVISIBLE */,
    CONSTRAINT `store_ibfk_1` FOREIGN KEY
(
    `address_id`
) REFERENCES `address`
(
    `id`
                                                               ...
                                                               ON DELETE CASCADE
                                                               ON UPDATE CASCADE,
    CONSTRAINT `store_ibfk_2` FOREIGN KEY
(
    `user_id`
) REFERENCES `user`
(
    `id`
                                                               ...
                                                               ON DELETE CASCADE
                                                               ON UPDATE CASCADE,
    CONSTRAINT `store_ibfk_3` FOREIGN KEY
(
    `category_id`
) REFERENCES `category`
(
...
(
    ...
    CONSTRAINT `menu_group_ibfk_1` FOREIGN KEY
(
    `store_id`
) REFERENCES `store`
(
...
(
    ...
    CONSTRAINT `options_ibfk_1` FOREIGN KEY
(
    `menu_id`
) REFERENCES `menu`
(
...
(
    `id`
                                                               ...
                                                               ON DELETE CASCADE
                                                               ON UPDATE CASCADE,
    CONSTRAINT `orders_ibfk_2` FOREIGN KEY
(
    `store_id`
) REFERENCES `store`
(
...
(
    ...
    CONSTRAINT `pay_ibfk_1` FOREIGN KEY
(
    `orders_id`
) REFERENCES `orders`
(
